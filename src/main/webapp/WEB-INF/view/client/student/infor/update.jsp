            ...
            <head>
                ...
                <script>
                    $(document).ready(() => {
                        ...
                        const orgImage = "${currentStudent.avatar}";
                        if (orgImage) {
                    ...
                    <div id="layoutSidenav_content">
                        <main>
                            <div class="container-fluid px-4">
                                <h1 class="mt-4">Update Student Infor</h1>
                                <ol class="breadcrumb mb-4">
                                    <li class="breadcrumb-item active"> <a href="/student">Dashboard</a> / <a
                                            href="/student/infor">Student Infor</a> / Update
                                    </li>
                                </ol>
                                ...
                                <div class="container mt-5">
                                    <div class="row">
                                        <div class="col-md-6 col-12 mx-auto">
                                            ...
                                            <hr />
                                            <form:form method="post" action="/student/infor/update"
                                                modelAttribute="currentStudent" enctype="multipart/form-data">
