            ...
            <div class="main-content">
              <div class="main-content-create">
                <div class="create-wrapper">
                  ...
                  <form:form class="create-form" method="post"
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        ...
                        <form:input type="text" class="form-control" path="midtermSorce" />
                      </div>
                      <div class="col-md-4">
                        <label class="form-label">Điểm cuối kỳ:</label>
                        <form:input type="text" class="form-control" path="finalSorce" />
                      </div>
                      <div class="col-md-4">
                        <label class="form-label">Điểm tổng kết:</label>
                        <form:input type="email" class="form-control" path="totalSorce" disabled="true" />
                      </div>
                      <div class="col-md-2">
