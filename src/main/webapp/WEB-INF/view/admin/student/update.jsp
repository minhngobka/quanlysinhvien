            ...
            <div class="main-content">
              <div class="main-content-create">
                <div class="create-wrapper">
                  ...
                  <form:form class="create-form" method="post" action="/admin/student/update"
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <form:input type="email" class="form-control" path="user.email" disabled="true" />
                      </div>
                      <div class="col-md-6">
                        <label class="form-label">MSSV:</label>
                        <form:input type="text" class="form-control" path="studentId" disabled="true" />
                      </div>
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <label for="avatarFile" class="form-label">Hình đại
                          diện:</label>
                        <input class="form-control" type="file" id="avatarFile" name="studentAvatarFile"
                          accept=".png, .jpg, .jpeg" />
                      </div>
                      <div class="col-md-12">
