            ...
            <div class="main-content">
              <div class="main-content-create">
                <div class="create-wrapper">
                  ...
                  <form:form class="create-form" method="post" action="/admin/class-course/create"
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <form:input type="text" class="form-control ${not empty errorClassCourseId ? 'is-invalid' : ''}"
                          path="classCourseId" />
                        ${errorClassCourseId}
                      </div>
                      <div class="col-md-6">
                      ...
                      <div class="col-md-4">
                        ...
                        <form:input type="text" class="form-control ${not empty errorClassroom ? 'is-invalid' : ''}"
                          path="classroom" />
                        ${errorClassroom}
                      </div>
                      <div class="col-md-4">
                        <label class="form-label">Tiết học:</label>
                        <form:input type="text" class="form-control ${not empty errorPreiod ? 'is-invalid' : ''}"
                          path="preiod" />
                        ${errorPreiod}
                      </div>
                      <div class="col-md-2">
                      ...
                      <div class="col-md-4">
                        ...
                        <form:input type="number"
                          class="form-control ${not empty errorStudentLimit ? 'is-invalid' : ''}" path="studentLimit" />
                        ${errorStudentLimit}
                      </div>

                      <div class="col-md-4">
                        <label class="form-label">Học kỳ:</label>
                        <form:input type="text" class="form-control ${not empty errorSemester ? 'is-invalid' : ''}"
                          path="semester" />
                        ${errorSemester}
                      </div>
