                        ...
                        <tbody>
                          ...
                          <c:forEach var="classCourse" items="${classCourses}">
                            <tr>
                              ...
                              <td>
                                <button>
                                  <a href="/admin/class-course/${classCourse.id}">View</a>
                                </button>
                                <button>
                                  <a href="/admin/class-course/update/${classCourse.id}">Update</a>
                                </button>
                                <button>
                                  <a href="/admin/class-course/delete/${classCourse.id}">Delete</a>
                                </button>
                              </td>
                            </tr>
                          </c:forEach>
